...
<head>
    ...
    <title id="PageTitle">รายงานรายการวัสดุแต่ละชนิด ตามปีงบประมาณ</title>
</head>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>รายงานรายการวัสดุแต่ละชนิด ตามปีงบประมาณ</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="dashboard_mat">หน้าหลัก</a></li>
                    <li class="breadcrumb-item">รายงาน</li>
                    <li class="breadcrumb-item active">รายงานรายการวัสดุแต่ละชนิด ตามปีงบประมาณ</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">ตารางรายงานรายการวัสดุแต่ละชนิด ตามปีงบประมาณ</h5>
                            <div class="row">
                            ...
                            <div class="table-responsive">
                                <table id="table-mat-budgetyear-report" class="text-center" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>ลำดับ</th>
                                            <th>ชื่อวัสดุ</th>
                                    ...
                                    <tbody class="text-left" id="bodyMAT_budgetyear_report">
                                    </tbody>
                                </table>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(async function() {
            ...
            await getMatBudgetyearReport().then(() => writeDataTable());


            $select = $(".BudgetYear_select").select2({
                width: "100%",
            });
        ...
        function writeDataTable() {
            $("#table-mat-budgetyear-report").DataTable({
        ...
        async function ChangeYeaer() {
            getMatBudgetyearReport().then(() => writeDataTable());
        ...
        async function getMatBudgetyearReport() {

            let budget_id = document.getElementById("BudgetYear_select").value;

            const url = "./controller/BudgetYearController.php?getMatBudgetyearReport=1&budget_id=" + budget_id;
            ...
            $("#table-mat-budgetyear-report").DataTable().destroy();

            const BudgetYearRep_list = document.getElementById("bodyMAT_budgetyear_report");
            ...
            BudgetYearRepData.forEach((element, i) => {
                ...
                <tr>
                    ...
                    <td align="left">${element.mat_bud_id}</td>
                    <td align="left">${element.budget_year}</td>
                    <td align="left">${parseFloat(element.mat_price).toLocaleString()} บาท</td>
                    <td align="left">${element.mat_stock}</td>
                </tr>
                `
            });
